...
#   TEMPLATE_FILE (default /seed/campaign-mens-circle.html)
set -eu

TPL_NAME="${TEMPLATE_NAME:-Männerkreis Niederbayern}"
TPL_FILE="${TEMPLATE_FILE:-/seed/campaign-mens-circle.html}"
...
# for the listmonk container to be healthy (i.e. install finished), but guard
# against a race with a short retry loop anyway.
i=0
